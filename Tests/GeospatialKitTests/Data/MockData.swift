...
final class MockData {
    ...
    static let geoJsonTestData: [GeoJsonDictionary] = { return TestData.geoJsonTestData["geoJsonObjects"] as! [GeoJsonDictionary] }()
    static let wktTestData: [GeoJsonDictionary] = { return TestData.geoJsonTestData["wktObjects"] as! [GeoJsonDictionary] }()
